...
{
    [Serializable]
    [DataContract(Name = "filestructurehistEntity", Namespace = "http://www.KAF.com/types")]
    public partial class filestructurehistEntity : BaseEntity
    {
        #region Properties
    
        protected long ? _filehistid;
        ...
        [DataMember]
        public long ? filehistid
        {
            get { return _filehistid; }
            set { _filehistid = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [Display(Name = "fileid", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._filestructurehist), ErrorMessageResourceName = "fileidRequired")]
        public long ? fileid
        {
            get { return _fileid; }
        ...
        [DataMember]
        [Display(Name = "folderid", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [MaxLength(350)]
        [Display(Name = "filename", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [MaxLength(350)]
        [Display(Name = "userfilename", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [MaxLength(350)]
        [Display(Name = "filepath", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [Display(Name = "isdeleted", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [MaxLength(256)]
        [Display(Name = "deletedbyuser", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        [DataMember]
        [Display(Name = "deleteddate", ResourceType = typeof(CLL.LLClasses.Models._filestructurehist))]
        ...
        public filestructurehistEntity():base()
        {
        }
        
        public filestructurehistEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public filestructurehistEntity(IDataReader reader, bool IsListViewShow)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("FileHistID"))) _filehistid = reader.GetInt64(reader.GetOrdinal("FileHistID"));
