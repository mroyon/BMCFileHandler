...
{
    [Serializable]
    [DataContract(Name = "folderstructurehistEntity", Namespace = "http://www.KAF.com/types")]
    public partial class folderstructurehistEntity : BaseEntity
    {
        #region Properties
    
        protected long ? _folderhistid;
        ...
        [DataMember]
        public long ? folderhistid
        {
            get { return _folderhistid; }
            set { _folderhistid = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [Display(Name = "folderid", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.Models._folderstructurehist), ErrorMessageResourceName = "folderidRequired")]
        ...
        [DataMember]
        [MaxLength(350)]
        [Display(Name = "foldername", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        [DataMember]
        [MaxLength(350)]
        [Display(Name = "physicalpath", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        [DataMember]
        [Display(Name = "parentfolderid", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        [DataMember]
        [Display(Name = "isdeleted", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        [DataMember]
        [MaxLength(256)]
        [Display(Name = "deletedbyuser", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        [DataMember]
        [Display(Name = "deleteddate", ResourceType = typeof(CLL.LLClasses.Models._folderstructurehist))]
        ...
        public folderstructurehistEntity():base()
        {
        }
        
        public folderstructurehistEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public folderstructurehistEntity(IDataReader reader, bool IsListViewShow)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("FolderHistID"))) _folderhistid = reader.GetInt64(reader.GetOrdinal("FolderHistID"));
