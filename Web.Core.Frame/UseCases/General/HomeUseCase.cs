                        ...
                        if (formItems.Where(p => p.ParentID == parentMenu.AppFormID).FirstOrDefault() != null)
                        {
                            foreach (Owin_ProcessGetFormActionistEntity_Ext form in formItems.Where(p => p.ParentID == parentMenu.AppFormID && p.IsView == true))
                            {
                                if (cultureInfo.Name.ToLower() == "ar-kw")
                                {
                                    ...
                                    menubuilder.Append("<li class='nav-item nav2'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='nav-icon fas fa-edit'></i><p> " + form.DisplayNameAr + "</p></a></li>");
                                }
                                else
                                {
                                    ...
                                    menubuilder.Append("<li class='nav-item nav2'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='nav-icon fas fa-edit'></i><p> " + form.DisplayName + "</p></a></li>");
                                }
                            }
                        }
            ...
            try
            {
                ...
                foreach (Owin_ProcessGetFormActionistEntity_Ext objparent in menuItems.Where(p => p.ParentID == ParentmenuID && p.IsView == true).ToList())
                {
                    ...
                    if (objparent.IsVisibleInMenu == true)
                    {
                        ...
                        menubuilder.Append("<a href='#' class='nav-link'><i class='nav-icon fas fa-layer-group'></i> <p>" + objparent.FormName + "<i class='right fas fa-angle-left'></i></p>");
                        //menubuilder.Append("<span class='pull-right-container'>");
                        //menubuilder.Append("<i class='right fas fa-angle-left'></i>");
                        //menubuilder.Append("</span>");
                        menubuilder.Append("</a>");
                        ...
                        menubuilder.Append("<ul class='nav nav-treeview' style='padding-left: 30px;'>");
                        if (formItems.Where(p => p.ParentID == objparent.AppFormID).FirstOrDefault() != null)
                        {
                            foreach (Owin_ProcessGetFormActionistEntity_Ext form in formItems.Where(p => p.ParentID == objparent.AppFormID && p.IsView == true))
                            {
                                if (cultureInfo.Name.ToLower() == "ar-kw")
                                {
                                    ...
                                    menubuilder.Append("<li class='nav-item childNav'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='fas nav-icon fas fa-edit nav-icon'></i><p> " + form.DisplayName + "</p></a></li>");
                                }
                                else
                                {
                                    //menubuilder.Append("<li class='nav-item childNav'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='fas fa-user-plus nav-icon'></i><p> " + form.DisplayName + "</p></a></li>");
                                    menubuilder.Append("<li class='nav-item childNav'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='nav-icon fas fa-edit'></i><p> " + form.DisplayName + "</p></a></li>");
                                }
                            }
                        }
                        ...
                        if (formItems.Where(p => p.ParentID == objparent.AppFormID).FirstOrDefault() != null)
                        {
                            foreach (Owin_ProcessGetFormActionistEntity_Ext form in formItems.Where(p => p.ParentID == objparent.AppFormID && p.IsView == true))
                            {
                                if (cultureInfo.Name.ToLower() == "ar-kw")
                                {
                                    ...
                                    menubuilder.Append("<li class='nav-item'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='nav-icon fas fa-edit'></i><p>" + form.DisplayNameAr + "</p></a></li>");
                                }
                                else
                                {
                                    ...
                                    menubuilder.Append("<li class='nav-item'><a href='" + DomURLPrefix + form.URL + form.ActionName + "' class='nav-link'><i class='nav-icon fas fa-edit'></i><p>" + form.DisplayName + "</p></a></li>");
                                }
                            }
                        }
